...
let template2 = document.querySelector("#test");
let clone2 = document.importNode(template2.content, true);

newContent2= clone.firstElementChild.innerHTML
            .replace(/{{test2}}/g, "https://static.fnac-static.com/multimedia/Images/8F/8F/7D/66/6716815-1505-1540-1/tsp20171122191008/Lego-lgtob12b-lego-batman-movie-lampe-torche-batman.jpg");
clone2.firstElementChild.innerHTML= newContent2;

let cardContainer2= document.querySelector("#tableContent2");
cardContainer2.appendChild(clone2);
});
